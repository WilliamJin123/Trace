...
involve judgment calls (merge resolution, trigger actions).
...
Public API:
    ...
    PendingTrigger        -- trigger action hook object
    GuidanceMixin        -- mixin for two-stage guidance pattern
    ValidationResult     -- per-item validation feedback
    HookRejection        -- structured rejection for trigger feedback
