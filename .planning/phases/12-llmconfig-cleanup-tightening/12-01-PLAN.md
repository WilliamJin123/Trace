...
must_haves:
  truths:
    ...
    - "Tract.open(model=...) creates LLMConfig internally; Tract.open(default_config=...) accepted; if both model= and default_config= provided simultaneously, ValueError is raised"
