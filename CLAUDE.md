...
**Before implementing ANY new feature, phase, or significant code change**, you MUST first create or update a tutorial writeup in the `tutorial/` directory. This is a hard requirement, not optional.
