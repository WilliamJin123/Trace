"""Tests for @t.tool decorator and callable_to_tool conversion."""
...
# ---------------------------------------------------------------------------
# @t.tool decorator integration tests
# ---------------------------------------------------------------------------


class TestToolDecorator:
    """Tests for the @t.tool decorator on Tract instances."""
    ...
    def test_basic_registration(self):
        with Tract.open(":memory:") as t:
            ...
            assert "greet" in t.custom_tools
            assert t.custom_tools["greet"].name == "greet"
    ...
    def test_with_name_override(self):
        with Tract.open(":memory:") as t:
            ...
            assert "say_hi" in t.custom_tools
            assert "greet" not in t.custom_tools

    def test_with_description_override(self):
        with Tract.open(":memory:") as t:
            @t.tool(description="Custom desc")
            def greet(name: str) -> str:
                """Original desc."""
                return f"Hello, {name}!"

            assert t.custom_tools["greet"].description == "Custom desc"
    ...
    def test_remove_tool(self):
        with Tract.open(":memory:") as t:
            ...
            assert "temp" in t.custom_tools
            t.remove_tool("temp")
            assert "temp" not in t.custom_tools
    ...
    def test_multiple_tools(self):
        with Tract.open(":memory:") as t:
            ...
            assert len(t.custom_tools) == 2
            assert "tool_a" in t.custom_tools
            assert "tool_b" in t.custom_tools
    ...
    def test_appears_in_as_tools(self):
        with Tract.open(":memory:") as t:
            ...
            tools = t.as_tools(profile="full", format="openai")
    ...
    def test_appears_in_as_tools_anthropic(self):
        with Tract.open(":memory:") as t:
            ...
            tools = t.as_tools(profile="full", format="anthropic")
    ...
    def test_custom_tools_property_is_copy(self):
        ...
        with Tract.open(":memory:") as t:
            ...
            assert "my_tool" in t.custom_tools  # internal still has it
    ...
    def test_imperative_registration(self):
        ...
        with Tract.open(":memory:") as t:
            ...
            t.tool(my_func)
            assert "my_func" in t.custom_tools
