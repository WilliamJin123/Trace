...
class TestCommitHash:
    ...
    def test_edit_target_included_when_set(self) -> None:
        """edit_target changes the hash when provided."""
        h1 = commit_hash("abc123", None, "dialogue", "edit", "2024-01-01T00:00:00Z")
        h2 = commit_hash("abc123", None, "dialogue", "edit", "2024-01-01T00:00:00Z", edit_target="target1")
        assert h1 != h2

    def test_edit_target_none_excluded_from_data(self) -> None:
        """When edit_target is None, it is excluded from the hash data."""
        # This ensures that None edit_target doesn't add a "edit_target": null entry
        h1 = commit_hash("abc", None, "instruction", "append", "2024-01-01T00:00:00Z")
        h2 = commit_hash("abc", None, "instruction", "append", "2024-01-01T00:00:00Z", edit_target=None)
        assert h1 == h2
